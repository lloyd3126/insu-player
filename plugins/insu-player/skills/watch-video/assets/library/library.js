(() => {
  ...
  const ACCENT_STORAGE_KEY = "insu-player:accent-color:v1";
  const FONT_STORAGE_KEY = "insu-player:font:v1";
  const FONT_OPTIONS = {
  ...
  const POLICY_STORAGE_KEY = "insu-player:usage-policy:v2";
  ...
  function applyFontSetting(value, persist = false) {
    const googleLinkId = "insu-google-font";
