...
--> statement-breakpoint
CREATE TABLE `extension_pairing_invitations` (
	`id` text PRIMARY KEY NOT NULL,
	...
	`expires_at` text NOT NULL,
	`claimed_at` text,
	`claimed_extension_origin` text,
	`revoked_at` text
);
--> statement-breakpoint
CREATE INDEX `extension_pairing_invitation_expiry_idx` ON `extension_pairing_invitations` (`expires_at`);--> statement-breakpoint
...
CREATE TABLE `local_media_imports` (
	`id` text PRIMARY KEY NOT NULL,
	`operation_id` text NOT NULL,
	`video_id` text,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `local_media_import_operation_idx` ON `local_media_imports` (`operation_id`);--> statement-breakpoint
CREATE INDEX `local_media_import_created_idx` ON `local_media_imports` (`created_at`);--> statement-breakpoint
...
CREATE TABLE `subtitle_style_presets` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `subtitle_style_preset_name_idx` ON `subtitle_style_presets` (`name`);--> statement-breakpoint
CREATE TABLE `subtitle_style_settings` (
	`id` text PRIMARY KEY NOT NULL,
	`active_styles_json` text NOT NULL,
	`active_preset_id` text,
	`updated_at` text NOT NULL,
	FOREIGN KEY (`active_preset_id`) REFERENCES `subtitle_style_presets`(`id`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
