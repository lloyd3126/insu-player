...
Current data contracts are clean-break only: SQLite media records use schema 2, content manifests use schema 5, segmentation plans use schema 4, and model transcripts use schema 3. Reject any other version and rebuild the job. Never migrate, coerce, or invoke a legacy reader.
