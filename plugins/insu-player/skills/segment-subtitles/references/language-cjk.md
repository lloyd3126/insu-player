...
For Japanese and Korean, do not reuse Chinese-specific grammar mechanically. Apply the shared CJK width behavior while the current Agent identifies language-specific particles, auxiliaries, bound endings, compound predicates, names, and syntactic closures.
