# Left-to-right spacing-script profile

Use this general profile for source or target languages whose writing system has reliable language-level spacing, including Latin, Cyrillic, Greek, and applicable Indic or other scripts. Continue to preserve Unicode grapheme clusters; a visible space is only a candidate and never proof of a safe seam.
