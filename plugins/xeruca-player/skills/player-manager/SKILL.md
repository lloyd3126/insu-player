...
~~~bash
python3 plugins/xeruca-player/skills/player-manager/scripts/manage.py status
...
- Codex plugin: run the official marketplace upgrade, then refresh `xeruca-player@xeruca-player`.
...
~~~bash
python3 plugins/xeruca-player/skills/player-manager/scripts/manage.py uninstall
~~~
